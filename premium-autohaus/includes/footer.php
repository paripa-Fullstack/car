<?php
/**
 * Premium Auto Haus - Footer Component
 * Comprehensive footer with navigation and contacts
 */
?>
            ...
            <div class="footer-grid">
                ...
                <div class="footer-column footer-column-brand">
                    ...
                    <p class="footer-description">
                        Премиальный автосалон с безупречной репутацией. 
                        Более 12 лет помогаем клиентам находить автомобили мечты.
                    </p>
                    ...
                    <div class="footer-social">
                        ...
                        <a href="<?php echo SOCIAL_INSTAGRAM; ?>" class="social-link instagram" target="_blank" rel="noopener" aria-label="Instagram">
                        ...
                        <a href="<?php echo SOCIAL_YOUTUBE; ?>" class="social-link youtube" target="_blank" rel="noopener" aria-label="YouTube">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div class="footer-column">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="/catalog.php">Каталог автомобилей</a></li>
                        <li><a href="/services.php">Услуги</a></li>
                        <li><a href="/reviews.php">Отзывы</a></li>
                        <li><a href="/news.php">Автожурнал</a></li>
                ...
                <div class="footer-column">
                    ...
                    <ul class="footer-links">
                        <li><a href="/services/buyout">Выкуп автомобилей</a></li>
                        <li><a href="/services/trade-in">Trade-In</a></li>
                        <li><a href="/services/credit">Автокредит</a></li>
                        <li><a href="/services/leasing">Лизинг</a></li>
                        <li><a href="/services/commission">Комиссионная продажа</a></li>
                ...
                <div class="footer-column">
                    ...
                    <ul class="footer-contact-list">
                        ...
                        <li class="footer-contact-item">
                            <svg class="icon icon-mail" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        ...
                        <li class="footer-contact-item">
                            <svg class="icon icon-clock" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <div class="container">
            <div class="footer-bottom-inner">
                <div class="footer-copyright">
                    <p>&copy; <?php echo date('Y'); ?> Premium Auto Haus. Все права защищены.</p>
                </div>
                
                <div class="footer-legal">
                    <a href="/page.php?slug=privacy-policy">Политика конфиденциальности</a>
                    <a href="/page.php?slug=terms">Пользовательское соглашение</a>
                    <a href="/page.php?slug=cookies">Cookie</a>
                </div>
                
                <div class="footer-developer">
                    <span>Разработано с любовью к автомобилям</span>
                </div>
            </div>
        </div>
    </div>
